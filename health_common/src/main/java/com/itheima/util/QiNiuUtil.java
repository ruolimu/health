...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "s31fwqJUa00Y9JFQzVghLXDE6nIharGCT1qfRJE7";
    private static final String SECRETKEY = "5B3Ft0pP1dBYJwipboplgxFhu";
    private static final String BUCKET = "ruoli";
    public static final String DOMAIN= "QiNiu Domain";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Eric\\Desktop\\zhengshuan.jpg","zhengshuan.jpg");
